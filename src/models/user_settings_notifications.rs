...
pub struct UserSettingsNotifications {
    ...
    #[serde(rename = "discordIds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "telegramMessageThreadId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
